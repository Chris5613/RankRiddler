...
router.get(
  "/csgo/getvotes/:valFormId",
  limiter,
  csgoController.getCsgoVotesByValFormId
);
...
router.post(
  "/overwatch/create",
  limiter,
  overwatchController.overwatchCreateVoteRecord
);
router.put(
  "/overwatch/record",
  limiter,
  overwatchController.overwatchVideoVote
);
router.get(
  "/overwatch/getvotes/:valFormId",
  limiter,
  overwatchController.getOverwatchVotesByValFormId
);
